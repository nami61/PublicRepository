...
bool aqua::controller::HoldAnalogStickLeft(aqua::controller::DEVICE_ID device, aqua::controller::STICK_DIRECTION direction, float input_threshold)
{
    return aqua::core::CController::GetInstance().HoldAnalogStickLeft(device, direction, input_threshold);
}
