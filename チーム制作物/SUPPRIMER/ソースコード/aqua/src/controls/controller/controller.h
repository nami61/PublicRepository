...
namespace aqua
{
    ...
    namespace core
    {
        ...
        public:
            ...
            *  @param[in]  device      デバイスID
            *  @param[in]  direction   方向ID
            *  @param[in]  input_threshold  入力の閾値(0.0f~1.0f)
            *
            *  @return     入力状態
            *  @retval     true    押され続けている
            *  @retval     false   押されていないか
            */
            bool            HoldAnalogStickLeft(aqua::controller::DEVICE_ID device, aqua::controller::STICK_DIRECTION direction, float input_threshold);
            ...
            /*!
             *   @brief    左アナログステックのトリガー判定
             * 
             *   @param[in]   device    デバイスID
             *   @param[in]   direction 方向ID
             *   @param[in]   input_threshold 　ステック入力のしきい値(0.0f～1.0f)
             */
            bool GetAnalogStickTriggerLeft(aqua::controller::DEVICE_ID device, aqua::controller::STICK_DIRECTION direction, float input_threshold);
            ...
            /*!
             *   @brief    右アナログステックのトリガー判定
             *
             *   @param[in]   device    デバイスID
             *   @param[in]   direction 方向ID
             *   @param[in]   input_threshold 　ステック入力のしきい値(0.0f～1.0f)
             */
            bool GetAnalogStickTriggerRight(aqua::controller::DEVICE_ID device, aqua::controller::STICK_DIRECTION direction, float input_threshold);
