...
void CTranslate::Translate(float& target, const float& start, const float& end, aqua::CTimer& timer, bool roop, EASING dir_mode)
{
...
void CTranslate::Translate(int& target, const int& start, const int& end, aqua::CTimer& timer, bool roop, EASING dir_mode)
{
...
void CTranslate::FadeDirection(aqua::CColor& color, aqua::CTimer& timer, unsigned int min, unsigned int max, DIRECTION_ID dir_mode)
{
	if (max > 255) max = 255;
